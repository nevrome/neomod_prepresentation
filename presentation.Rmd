...
>     - Grabanlage- und Vergesellschaftung (Nachnutzung neolithischer Megalithik, Gräberfelder) 
>     - Grabbau (Särge, Totenhäuser, Bootsgräber)
>     - Beigabenauswahl
...
edges2 <- edges1 %>% rbind(
  tibble::tibble(
    from = c(1,2,1,2 , 3,4, 6,7,6,7, 6, 7, 11,12,11,12,11,12,  8,14, 8,14, 8,14,  8,  8,14),
