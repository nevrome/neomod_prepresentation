...
<section data-background-video="/home/clemens/neomod/neomod_datapool/bronze_age/the_movie_3.mp4" 
...
<div class="fragment" data-fragment-index="1">
- Bestattungsrituale sind nur eingeschränkt natürlich determiniert und haben geringe Auswirkung auf die Subsistenz: Sie haben eine **relativ geringe Wechselwirkung** mit dem **Mensch-Umwelt-System**.
</div>
...
- Mit welcher **Geschwindigkeit** breiten sich Ideen in einer Population unter verschiedenen Populationsparametern aus?
- Über welche **Ausbreitungsmodi** und Kanäle verbreiten sich **Ideen, die weder funktional noch Mode sind**?
- Welche Rolle spielen die klassischen Kategorien der **Diffusion of Innovation** Forschung (z.B. Tradition vs. Innovation, Early Adopters vs. Laggards) für sehr stabile Ideen über lange Zeiträume?

\

- Erklären **diachrone Veränderungen der Populationsparameter** Ablöseereignisse (z.B. Bottlenecks -> Drift)?
- Ist die räumlich-zeitliche **Korrelation verschiedener Ideen** Ausdruck kausaler Relation oder Nebeneffekt von Transmissionsstrukturen?
